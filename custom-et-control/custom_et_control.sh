...
function custom_et_control_prehook_hookable_for_languages() {
	...
	arr["ENGLISH","custom_et_text_3"]="Use exact original BSSID \${normal_color}(\${bssid})"
	arr["SPANISH","custom_et_text_3"]="Usar el BSSID original exacto \${normal_color}(\${bssid})"
	arr["FRENCH","custom_et_text_3"]="\${pending_of_translation} Utiliser le BSSID original exact \${normal_color}(\${bssid})"
	arr["CATALAN","custom_et_text_3"]="\${pending_of_translation} Utilitzar el BSSID original exacte \${normal_color}(\${bssid})"
	arr["PORTUGUESE","custom_et_text_3"]="\${pending_of_translation} Usar o BSSID original exato \${normal_color}(\${bssid})"
	arr["RUSSIAN","custom_et_text_3"]="\${pending_of_translation} Использовать точный исходный BSSID \${normal_color}(\${bssid})"
	arr["GREEK","custom_et_text_3"]="\${pending_of_translation} Χρησιμοποιήστε το ακριβές αρχικό BSSID \${normal_color}(\${bssid})"
	arr["ITALIAN","custom_et_text_3"]="\${pending_of_translation} Usa l'esatto BSSID originale \${normal_color}(\${bssid})"
	arr["POLISH","custom_et_text_3"]="\${pending_of_translation} Użyj dokładnego oryginalnego BSSID \${normal_color}(\${bssid})"
	arr["GERMAN","custom_et_text_3"]="Exakte originale BSSID verwenden \${normal_color}(\${bssid})"
	arr["TURKISH","custom_et_text_3"]="\${pending_of_translation} Tam orijinal BSSID'yi kullan \${normal_color}(\${bssid})"
	arr["ARABIC","custom_et_text_3"]="\${pending_of_translation} استخدام BSSID الأصلي بالضبط \${normal_color}(\${bssid})"
	arr["CHINESE","custom_et_text_3"]="\${pending_of_translation} 使用确切的原始 BSSID \${normal_color}(\${bssid})"
	...
	arr["ENGLISH","custom_et_text_6"]="OK. Original BSSID will be used: \${normal_color}\${custom_et_chosen_bssid}"
	arr["SPANISH","custom_et_text_6"]="OK. Se utilizará el BSSID original: \${normal_color}\${custom_et_chosen_bssid}"
	arr["FRENCH","custom_et_text_6"]="\${pending_of_translation} OK. Le BSSID original sera utilisé : \${normal_color}\${custom_et_chosen_bssid}"
	arr["CATALAN","custom_et_text_6"]="\${pending_of_translation} OK. S'utilitzarà el BSSID original: \${normal_color}\${custom_et_chosen_bssid}"
	arr["PORTUGUESE","custom_et_text_6"]="\${pending_of_translation} OK. O BSSID original será usado: \${normal_color}\${custom_et_chosen_bssid}"
	arr["RUSSIAN","custom_et_text_6"]="\${pending_of_translation} ОК. Будет использован исходный BSSID: \${normal_color}\${custom_et_chosen_bssid}"
	arr["GREEK","custom_et_text_6"]="\${pending_of_translation} OK. Το αρχικό BSSID θα χρησιμοποιηθεί: \${normal_color}\${custom_et_chosen_bssid}"
	arr["ITALIAN","custom_et_text_6"]="\${pending_of_translation} OK. Verrà utilizzato il BSSID originale: \${normal_color}\${custom_et_chosen_bssid}"
	arr["POLISH","custom_et_text_6"]="\${pending_of_translation} OK. Zostanie użyty oryginalny BSSID: \${normal_color}\${custom_et_chosen_bssid}"
	arr["GERMAN","custom_et_text_6"]="OK. Die originale BSSID wird verwendet: \${normal_color}\${custom_et_chosen_bssid}"
	arr["TURKISH","custom_et_text_6"]="\${pending_of_translation} Tamam. Orijinal BSSID kullanılacak: \${normal_color}\${custom_et_chosen_bssid}"
	arr["ARABIC","custom_et_text_6"]="\${pending_of_translation} حسنا. سيتم استخدام BSSID الأصلي: \${normal_color}\${custom_et_chosen_bssid}"
	arr["CHINESE","custom_et_text_6"]="\${pending_of_translation} 好的。将使用原始 BSSID： \${normal_color}\${custom_et_chosen_bssid}"
	...
	arr["GREEK","custom_et_text_7"]="\${pending_of_translation} Προειδοποίηση: Αυτό μπορεί προκαλέσει αστάθεια στο δίκτυο!"
	...
	arr["ENGLISH","custom_et_text_9"]="BSSID has been set to: \${normal_color}\${custom_et_chosen_bssid}"
	arr["SPANISH","custom_et_text_9"]="BSSID se ha configurado en: \${normal_color}\${custom_et_chosen_bssid}"
	arr["FRENCH","custom_et_text_9"]="\${pending_of_translation} Le BSSID a été défini sur : \${normal_color}\${custom_et_chosen_bssid}"
	arr["CATALAN","custom_et_text_9"]="\${pending_of_translation} El BSSID s'ha establert a: \${normal_color}\${custom_et_chosen_bssid}"
	arr["PORTUGUESE","custom_et_text_9"]="\${pending_of_translation} O BSSID foi definido para: \${normal_color}\${custom_et_chosen_bssid}"
	arr["RUSSIAN","custom_et_text_9"]="\${pending_of_translation} BSSID был установлен на: \${normal_color}\${custom_et_chosen_bssid}"
	arr["GREEK","custom_et_text_9"]="\${pending_of_translation} Το BSSID έχει οριστεί σε: \${normal_color}\${custom_et_chosen_bssid}"
	arr["ITALIAN","custom_et_text_9"]="\${pending_of_translation} Il BSSID è stato impostato su: \${normal_color}\${custom_et_chosen_bssid}"
	arr["POLISH","custom_et_text_9"]="\${pending_of_translation} BSSID został ustawiony na: \${normal_color}\${custom_et_chosen_bssid}"
	arr["GERMAN","custom_et_text_9"]="BSSID wurde gesetzt auf: \${normal_color}\${custom_et_chosen_bssid}"
	arr["TURKISH","custom_et_text_9"]="\${pending_of_translation} BSSID şu olarak ayarlandı: \${normal_color}\${custom_et_chosen_bssid}"
	arr["ARABIC","custom_et_text_9"]="\${pending_of_translation} تم تعيين BSSID إلى: \${normal_color}\${custom_et_chosen_bssid}"
	arr["CHINESE","custom_et_text_9"]="\${pending_of_translation} BSSID 已设置为： \${normal_color}\${custom_et_chosen_bssid}"
	...
	arr["ENGLISH","custom_et_text_12"]="Current channel: \${normal_color}\${channel}"
	arr["SPANISH","custom_et_text_12"]="Canal actual: \${normal_color}\${channel}"
	arr["FRENCH","custom_et_text_12"]="\${pending_of_translation} Canal actuel : \${normal_color}\${channel}"
	arr["CATALAN","custom_et_text_12"]="\${pending_of_translation} Canal actual: \${normal_color}\${channel}"
	arr["PORTUGUESE","custom_et_text_12"]="\${pending_of_translation} Canal atual: \${normal_color}\${channel}"
	arr["RUSSIAN","custom_et_text_12"]="\${pending_of_translation} Текущий канал: \${normal_color}\${channel}"
	arr["GREEK","custom_et_text_12"]="\${pending_of_translation} Τρέχον κανάλι: \${normal_color}\${channel}"
	arr["ITALIAN","custom_et_text_12"]="\${pending_of_translation} Canale attuale: \${normal_color}\${channel}"
	arr["POLISH","custom_et_text_12"]="\${pending_of_translation} Aktualny kanał: \${normal_color}\${channel}"
	arr["GERMAN","custom_et_text_12"]="Aktueller Kanal: \${normal_color}\${channel}"
	arr["TURKISH","custom_et_text_12"]="\${pending_of_translation} Geçerli kanal: \${normal_color}\${channel}"
	arr["ARABIC","custom_et_text_12"]="\${pending_of_translation} القناة الحالية: \${normal_color}\${channel}"
	arr["CHINESE","custom_et_text_12"]="\${pending_of_translation} 当前信道： \${normal_color}\${channel}"
	...
	arr["ENGLISH","custom_et_text_13"]="Channel has been set to: \${normal_color}\${channel}"
	arr["SPANISH","custom_et_text_13"]="El canal se configuró en: \${normal_color}\${channel}"
	arr["FRENCH","custom_et_text_13"]="\${pending_of_translation} Le canal a été défini sur : \${normal_color}\${channel}"
	arr["CATALAN","custom_et_text_13"]="\${pending_of_translation} El canal s'ha establert a: \${normal_color}\${channel}"
	arr["PORTUGUESE","custom_et_text_13"]="\${pending_of_translation} O canal foi definido para: \${normal_color}\${channel}"
	arr["RUSSIAN","custom_et_text_13"]="\${pending_of_translation} Канал установлен на: \${normal_color}\${channel}"
	arr["GREEK","custom_et_text_13"]="\${pending_of_translation} Το κανάλι έχει οριστεί σε: \${normal_color}\${channel}"
	arr["ITALIAN","custom_et_text_13"]="\${pending_of_translation} Il canale è stato impostato su: \${normal_color}\${channel}"
	arr["POLISH","custom_et_text_13"]="\${pending_of_translation} Kanał został ustawiony na: \${normal_color}\${channel}"
	arr["GERMAN","custom_et_text_13"]="Kanal wurde gesetzt auf: \${normal_color}\${channel}"
	arr["TURKISH","custom_et_text_13"]="\${pending_of_translation} Kanal şu olarak ayarlandı: \${normal_color}\${channel}"
	arr["ARABIC","custom_et_text_13"]="\${pending_of_translation} تم تعيين القناة إلى: \${normal_color}\${channel}"
	arr["CHINESE","custom_et_text_13"]="\${pending_of_translation} 信道已设置为： \${normal_color}\${channel}"

	arr["ENGLISH","custom_et_text_14"]="Keeping standard channel: \${normal_color}\${channel}"
	arr["SPANISH","custom_et_text_14"]="Manteniendo el canal estándar: \${normal_color}\${channel}"
	arr["FRENCH","custom_et_text_14"]="\${pending_of_translation} Conservation du canal standard : \${normal_color}\${channel}"
	arr["CATALAN","custom_et_text_14"]="\${pending_of_translation} Es manté el canal estàndard: \${normal_color}\${channel}"
	arr["PORTUGUESE","custom_et_text_14"]="\${pending_of_translation} Mantendo o canal padrão: \${normal_color}\${channel}"
	arr["RUSSIAN","custom_et_text_14"]="\${pending_of_translation} Сохранение стандартного канала: \${normal_color}\${channel}"
	arr["GREEK","custom_et_text_14"]="\${pending_of_translation} Διατήρηση τυπικού καναλιού: \${normal_color}\${channel}"
	arr["ITALIAN","custom_et_text_14"]="\${pending_of_translation} Mantenimento del canale standard: \${normal_color}\${channel}"
	arr["POLISH","custom_et_text_14"]="\${pending_of_translation} Zachowanie standardowego kanału: \${normal_color}\${channel}"
	arr["GERMAN","custom_et_text_14"]="Standard-Kanal wird verwendet: \${normal_color}\${channel}"
	arr["TURKISH","custom_et_text_14"]="\${pending_of_translation} Standart kanal korunuyor: \${normal_color}\${channel}"
	arr["ARABIC","custom_et_text_14"]="\${pending_of_translation} الاحتفاظ بالقناة القياسية: \${normal_color}\${channel}"
	arr["CHINESE","custom_et_text_14"]="\${pending_of_translation} 保持标准信道： \${normal_color}\${channel}"
	...
	arr["ENGLISH","custom_et_text_21"]="ESSID has been set to: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["SPANISH","custom_et_text_21"]="ESSID se ha configurado en: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["FRENCH","custom_et_text_21"]="\${pending_of_translation} L'ESSID a été défini sur : \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["CATALAN","custom_et_text_21"]="\${pending_of_translation} L'ESSID s'ha establert a: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["PORTUGUESE","custom_et_text_21"]="\${pending_of_translation} O ESSID foi definido para: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["RUSSIAN","custom_et_text_21"]="\${pending_of_translation} ESSID был установлен на: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["GREEK","custom_et_text_21"]="\${pending_of_translation} Το ESSID έχει οριστεί σε: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["ITALIAN","custom_et_text_21"]="\${pending_of_translation} L'ESSID è stato impostato su: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["POLISH","custom_et_text_21"]="\${pending_of_translation} ESSID został ustawiony na: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["GERMAN","custom_et_text_21"]="ESSID wurde gesetzt auf: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["TURKISH","custom_et_text_21"]="\${pending_of_translation} ESSID şu olarak ayarlandı: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["ARABIC","custom_et_text_21"]="\${pending_of_translation} تم تعيين ESSID إلى: \${normal_color}\"\${custom_et_chosen_essid}\""
	arr["CHINESE","custom_et_text_21"]="\${pending_of_translation} ESSID 已设置为： \${normal_color}\"\${custom_et_chosen_essid}\""

	arr["ENGLISH","custom_et_text_23"]="OK. Standard airgeddon ESSID will be used: \${normal_color}\"\${essid}\""
	arr["SPANISH","custom_et_text_23"]="OK. Se utilizará el ESSID estándar de airgeddon: \${normal_color}\"\${essid}\""
	arr["FRENCH","custom_et_text_23"]="\${pending_of_translation} OK. L'ESSID standard d'airgeddon sera utilisé: \${normal_color}\"\${essid}\""
	arr["CATALAN","custom_et_text_23"]="\${pending_of_translation} OK. S'utilitzarà l'ESSID estàndard d'airgeddon: \${normal_color}\"\${essid}\""
	arr["PORTUGUESE","custom_et_text_23"]="\${pending_of_translation} OK. O ESSID padrão do airgeddon será usado: \${normal_color}\"\${essid}\""
	arr["RUSSIAN","custom_et_text_23"]="\${pending_of_translation} ОК. Будет использован стандартный ESSID airgeddon: \${normal_color}\"\${essid}\""
	arr["GREEK","custom_et_text_23"]="\${pending_of_translation} OK. Θα χρησιμοποιηθεί το τυπικό ESSID του airgeddon: \${normal_color}\"\${essid}\""
	arr["ITALIAN","custom_et_text_23"]="\${pending_of_translation} OK. Verrà utilizzato l'ESSID standard di airgeddon: \${normal_color}\"\${essid}\""
	arr["POLISH","custom_et_text_23"]="\${pending_of_translation} OK. Zostanie użyty standardowy ESSID airgeddon: \${normal_color}\"\${essid}\""
	arr["GERMAN","custom_et_text_23"]="OK. Die Standard airgeddon ESSID wird verwendet: \${normal_color}\"\${essid}\""
	arr["TURKISH","custom_et_text_23"]="\${pending_of_translation} Tamam. Standart airgeddon ESSID kullanılacak: \${normal_color}\"\${essid}\""
	arr["ARABIC","custom_et_text_23"]="\${pending_of_translation} حسنا. سيتم استخدام ESSID الافتراضي لـ airgeddon: \${normal_color}\"\${essid}\""
	arr["CHINESE","custom_et_text_23"]="\${pending_of_translation} 好的。将使用标准 airgeddon ESSID： \${normal_color}\"\${essid}\""
...
function custom_et_control_interactive_prompt() {
	...
	echo "1. $(language_strings "${lang_key}" "custom_et_text_17" "return")"
	echo "2. $(language_strings "${lang_key}" "custom_et_text_18" "return")"
